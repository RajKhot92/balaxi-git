<?php
    ...
    /*  Adding new category     */
    $add_category_sql = "INSERT INTO query_category (category_name,ent_by,ent_dt,del_by,del_dt)
                        VALUES (UPPER('".$category_name."'),".$login_id.",CURDATE(),null,null)";

    if ($conn->query($add_category_sql) !== TRUE) {
        echo "Some error occurred while adding new query category. Please try again later.";
        exit();
    }
